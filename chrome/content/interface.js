...
/**
 * Enable or disable the go to previous command (and related elements)
 *
 * @param enable boolean true if the command must be enabled
 * @author Fragile
 */

function enableGoToPrevious( enable )
{
	if( enable ) 	document.getElementById('cmd_ple_goToPrevious').removeAttribute('disabled');
	else 			document.getElementById('cmd_ple_goToPrevious').setAttribute('disabled','true');
}
